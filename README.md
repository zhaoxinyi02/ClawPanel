...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.4.2` 与 `ClawPanel Lite v0.3.2` 已发布；本次聚焦通道管理与日志体验：新增 QQ 官方机器人内置版/社区版切换、优化 QQBot 配置分层、修复最近活动漏消息、补齐日志分类与筛选稳定性。详情见 [changelogs/v5.4.2.md](changelogs/v5.4.2.md) 与 [changelogs/lite-v0.3.2.md](changelogs/lite-v0.3.2.md)。
