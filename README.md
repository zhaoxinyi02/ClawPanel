...
[![Pro](https://img.shields.io/badge/Pro-5.3.2-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
[![Lite](https://img.shields.io/badge/Lite-0.2.2-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.3.2` 与 `ClawPanel Lite v0.2.2` 已发布；本次重点带来面板聊天能力、官方插件通道直装兜底和最近版本文档整理。若一键安装/手动更新没有拿到最新版，请优先重新拉取安装脚本或检查加速服务器元数据是否已同步。
