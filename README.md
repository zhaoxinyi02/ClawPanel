...
[![Lite](https://img.shields.io/badge/Lite-0.1.7-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.8` 补强 macOS OpenClaw 探测、受管工作区兼容与 MiniMax 默认配置；`ClawPanel Lite v0.1.7` 进一步收紧 Lite 与本机外部 `openclaw` 的隔离，三端安装/卸载脚本与公开下载入口已完成校验。详见 [changelogs/v5.2.8.md](changelogs/v5.2.8.md) 和 [changelogs/lite-v0.1.7.md](changelogs/lite-v0.1.7.md)
