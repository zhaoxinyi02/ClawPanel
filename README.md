...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.4.3` 与 `ClawPanel Lite v0.3.3` 已发布；本次聚焦会话与交互稳定性：修复 Telegram 多实例通道定义匹配、补齐 AI 助手最小化/窗口控制、修复面板会话在运行时与主会话目录之间的读取回退。详情见 [changelogs/v5.4.3.md](changelogs/v5.4.3.md) 与 [changelogs/lite-v0.3.3.md](changelogs/lite-v0.3.3.md)。
