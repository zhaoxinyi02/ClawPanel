...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.4.5` 与 `ClawPanel Lite v0.3.5` 已发布；本次重点修复工作流交付链路：Markdown 产物自动导出 Word/Excel（活动模板优先）、微信文件回传字段兼容增强、发布步骤默认回传真实业务产物。详情见 [changelogs/v5.4.5.md](changelogs/v5.4.5.md) 与 [changelogs/lite-v0.3.5.md](changelogs/lite-v0.3.5.md)。
